...
public class DataGenerator {
    ...
    public static String generateDate(int shift) {
        ...
        LocalDate currentDate = localDate.plusDays(shift);
    ...
    public static String generateCity() {
        String[] citi = {"Майкоп", "Горно-Алтайск", "Уфа", "Улан-Удэ", "Махачкала", "Магас", "Нальчик", "Элиста", "Черкесск", "Петрозаводск", "Сыктывкар", "Симферополь", "Йошкар-Ола", "Саранск",
        ...
        Random randomCiti = new Random();
        String city = citi[randomCiti.nextInt(citi.length)];
